        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
          ...
          <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-light mb-8 text-gray-900 dark:text-gray-100 leading-tight">
              ...
              <span className="font-medium md:text-7xl bg-blue-600 dark:bg-blue-400 bg-clip-text text-transparent">
                Intelligent
              </span>{" "}
              Automation
            </h1>
          ...
          <div className="md:w-1/2 flex justify-center max-h-screen overflow-hidden">
            <BentoGrid />
          </div>
        </div>
      </div>
